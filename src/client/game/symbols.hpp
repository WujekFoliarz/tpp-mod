...
namespace game
{
	...
	namespace fox
	{
		...
		WEAK symbol<bool(fox::RawKeyboardData*, RAWKEYBOARD*)> GetRawKeyboardData{0x141A45650, 0x1414A1D60, 0x141A45A30, 0x1414A1C60};

		WEAK symbol<void(void*, unsigned int)> FreeAnnotated{0x140015F90, 0x140016020, 0x140015EE0, 0x140016020};

		WEAK symbol<QuarkSystemTable*()> GetQuarkSystemTable{0x146CDE8D0, 0x148F1D020, 0x148B24E40, 0x148051AD0};

		WEAK symbol<game::fox::StringId(const char*, size_t)> FoxStrHash32{0x1400234e0, 0x140022F30, 0x140023220, 0x140022FD0};
		...
		{
			WEAK symbol<void(fox::RawMouseData*)> SetRawData{0x140031AF0, 0x140031670, 0x140031C40, 0x140031700};
		}

		namespace Buffer_
		{
			WEAK symbol<size_t(fox::Buffer* buffer)> GetSize{0x141C6C960, 0x1406C4D70, 0x140EFE0E0, 0x140F54B80};
		...
		namespace LuaAutoPtr_
		{
			...
			WEAK symbol<void(LuaAutoPtr*)> LuaAutoPtr__destructor{0x14006A960, 0x14006B720, 0x14006A8B0, 0x14006B590};
		}
		...
		namespace fs
		{
			...
			{
				WEAK symbol<__int64(const char*)> FromString{0x14003DB30, 0x14003DB70, 0x14003DE50, 0x14003DC30};
			}
		}
		...
		namespace nt
		{
			...
			namespace Member_
			{
				WEAK symbol<void(Member*)> Reset{0x1403174F0, 0x140C54BD0, 0x1403179A0, 0x140C546A0};
			}
		}
		...
		namespace ui
		{
			...
			namespace Font_
			{
				WEAK symbol<bool(Font*, const char*, float, float, float, 
					Vectormath::Aos::Vector2*, Vectormath::Aos::Vector2*, float*, float*)> CreateText{0x141DF62E0, 0x140E67FD0, 0x141DF6150, 0x140E67A80};
			}

			namespace FontManager_
			{
				WEAK symbol<FontManager::FontGroup*(FontManager*, StringId, unsigned int)> GetFontGroup{0x141DBE140, 0x14B35A370, 0x141DD5410, 0x140E45B10};
			}
		}
		...
		namespace gr
		{
			namespace dg
			{
				...
				{
					WEAK symbol<void(CommandBuffer*, int, unsigned int)> SetTexture{0x1402D8AA0, 0x140BCAAD0, 0x1402D8E70, 0x140BCA120};
				...
				{
					WEAK symbol<char*(DynamicVertexBuffer*, gn::Buffer**, unsigned int*, int)> GetBuffer{0x1402B97E0, 0x140BBA240, 0x1402B9DC0, 0x140BB9890};
				}
				...
				namespace FontSystem_
				{
					...
					WEAK symbol<void*(FontSystem*, const char*, int)> RegisterString{0x1402250f0, 0x140B2B600, 0x1402256B0, 0x140B2ABB0};
					WEAK symbol<void*(FontSystem*, const char*, int)> UnRegisterString{0x1402261e0, 0x140B2C5B0, 0x1402267A0, 0x140B2BB60};
					...
					WEAK symbol<_TextureGlyphData*(FontSystem*)> GetFontTextureGlyphDataTop{0x140224380, 0x140B2A8A0, 0x140224950, 0x140B29E50};
				...
				namespace plugins
				{
					namespace Draw2DRenderer_
					{
						...
						WEAK symbol<void(Draw2DRenderer*, int, int, int)> DrawVertices{0x1402E7160, 0x140BDA520, 0x1402E7670, 0x140BD9B20};

						/* 01 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DLine*)> Execute_Packet2DLine{0x1402E2370, 0x140BD5A60, 0x1402E27E0, 0x140BD5060};
						/* 02 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DTriangle*)> Execute_Packet2DTriangle{0x1402E44F0, 0x140BD7BE0, 0x1402E4960, 0x140BD71E0};
						/* 03 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DQuad*)> Execute_Packet2DQuad{0x1402E2D90, 0x140BD6480, 0x1402E3200, 0x140BD5A80};
						...
						/* 06 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DSprite2D*)> Execute_Packet2DSprite2D{0x1402E38F0, 0x140BD6FE0, 0x1402E3D60, 0x140BD65E0};
						...
						/* 08 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DString*)> ExecuteOnly_Packet2DString{0x1402E4E50, 0x140BD8540, 0x1402E52C0, 0x140BD7B40};
						...
						/* 10 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DCube*)> Execute_Packet2DCube{0x1402E0640, 0x140BD3D30, 0x1402E0AB0, 0x140BD3330};
						/* 11 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DLineStrip*)> Execute_Packet2DLineStrip{0x1402E2560, 0x140BD5C50, 0x1402E29D0, 0x140BD5250};
						/* 12 */ template<size_t Count> symbol<void*(Draw2DRenderer*, Packet2DTriangleStrip<Count>*)> Execute_Packet2DTriangleStrip{0x1402E4780, 0x140BD7E70, 0x1402E4BF0, 0x140BD7470};
						/* 13 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DViewport*)> Execute_Packet2DViewport{0x1402E4AD0, 0x140BD81C0, 0x1402E4F40, 0x140BD77C0};
						...
						/* 21 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DBillboard*)> Execute_Packet2DBillboard{0x1402DF4B0, 0x140BD2BA0, 0x1402DF920, 0x140BD21A0};
						...
						/* 25 */ WEAK symbol<void*(Draw2DRenderer*, char)> SetCullMode{0x1402E8130, 0x140BDB4C0, 0x1402E8640, 0x140BDAAC0};
						/* 26 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DTexture*)> Execute_Packet2DTexture{0x1402E43C0, 0x140BD7AB0, 0x1402E4830, 0x140BD70B0};
						/* 27 */ WEAK symbol<void*(Draw2DRenderer*, char)> SetAlpha{0x1402E7E10, 0x140BDB1A0, 0x1402E8320, 0x140BDA7A0};
						/* 28 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DColor*)> Execute_Packet2DColor{0x1402E04B0, 0x140BD3BA0, 0x1402E0920, 0x140BD31A0};
						/* 29 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DStencil*)> SetStencil{0x1402E82E0, 0x140BDB670, 0x1402E87F0, 0x140BDAC70};
						...
						/* 38 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DPush*)> Execute_Packet2DPush{0x1402E2D00, 0x140BD63F0, 0x1402E3170, 0x140BD59F0};
						/* 39 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DPop*)> Execute_Packet2DPop{0x1402E2C30, 0x140BD6320, 0x1402E30A0, 0x140BD5920};
						/* 40 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DResolve*)> Execute_Packet2DResolve{0x1402E3670, 0x140BD6D60, 0x1402E3AE0, 0x140BD6360};
						/* 41 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DCopyRenderTarget*)> Execute_Packet2DCopyRenderTarget{0x1402E05B0, 0x140BD3CA0, 0x1402E0A20, 0x140BD32A0};
						/* 45 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DDrawIndices*)> Execute_Packet2DDrawIndices{0x1402E1F80, 0x140BD5670, 0x1402E23F0, 0x140BD4C70};
						/* 46 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DUserVertexBuffer*)> Execute_Packet2DUserVertexBuffer{0x1402E4960, 0x140BD8050, 0x143E14100, 0x140BD7650};
						/* 47 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DBeginRenderToTemporary*)> Execute_Packet2DBeginRenderToTemporary{0x1402DF350, 0x140BD2A40, 0x1402DF7C0, 0x140BD2040};
						...
						/* 49 */ WEAK symbol<void*(Draw2DRenderer*, Packet2DSetTemporaryTexture*)> Execute_Packet2DSetTemporaryTexture{0x1402E3850, 0x140BD6F40, 0x1402E3CC0, 0x140BD6540};
					}
				}
				...
				{
					WEAK symbol<DgTextureStreamer*()> Instance{0x14021D890, 0x140B23E40, 0x14021DCC0, 0x140B233F0};
					WEAK symbol<bool(DgTextureStreamer*)> IsEnable{0x14021DE50, 0x140B23F30, 0x14021DDB0, 0x140B234E0};
					WEAK symbol<bool(DgTextureStreamer*, ResourceId, char)> RequestTextureDetailByDgTexture{0x14021E720, 0x149C46A00, 0x14021EB50, 0x140B24230};
					WEAK symbol<bool(DgTextureStreamer*, ResourceId, char)> UnRequestTextureDetailByDgTexture{0x14021F940, 0x140B25E60, 0x14021FD70, 0x140B25410};
				}
				...
				namespace ResourceManagerBase_
				{
					...
					{
						WEAK symbol<void(ResourceId)> DeleteResource{0x1401B73F0, 0x1402F6360, 0x1401B7370, 0x1402F62E0};
					}
				}
			}
			...
			namespace Material_
			{
				...
				WEAK symbol<void(Material*, unsigned int, Texture*)> BindTexture{0x140276ee0, 0x140AB3C20, 0x140276CA0, 0x140AB3230};
			...
			namespace Texture_
			{
				WEAK symbol<Texture**(Texture**, StringId*)> Create{0x1401B6F50, 0x140AA8670, 0x1401B6ED0, 0x140AA7DE0};
			}

			namespace Font_
			{
				WEAK symbol<int(const char*, float*, bool, unsigned int)> GetStringWidth{0x141C32A20, 0x140B00030, 0x141C31E70, 0x140AFF4E0};
			}

			WEAK symbol<void*(dg::StringFontMetricsCache*, const char*, int, int)> InitMetrics{0x1402AF1E0, 0x140BA6560, 0x1402AF6A0, 0x140BA5B60};

			WEAK symbol<void(_fp16*, Vectormath::Aos::Vector4*)> ConvertFloat4toHalf4{0x140302b40, 0x140BF5F40, 0x1403030A0, 0x140BF5540};
			WEAK symbol<void(Vectormath::Aos::Vector4*, _fp16*)> ConvertHalf4toFloat4{0x140302D40, 0x14050CFA0, 0x141C4EDC0, 0x140C18D00};
	...
	namespace tpp
	{
		...
		namespace gm
		{
			namespace player
			{
				...
				namespace impl
				{
					...
					{
						WEAK symbol<bool()> IsLoading{0x1409D6590, 0x1407B8290, 0x147F69AF0, 0x1407B7C20};
					}
				}
			}
		}
		...
		namespace ui
		{
			namespace hud
			{
				namespace CommonDataManager_
				{
					...
					WEAK symbol<void(CommonDataManager*, const char*, int, int, int)> AnnounceLogView{0x140863c60, 0x1405E7610, 0x140862CE0, 0x1405E7020};
				...
				{
					WEAK symbol<char(void* a1, const char* text, char a3, char a4, char a5)> CallLogView{0x14093EF80, 0x1463CA640, 0x147C2A370, 0x146DFB540};
					WEAK symbol<char(AnnounceLogViewer*, char)> ModelInit{0x14093F280, 0x1406C9150, 0x14093E200, 0x1406C8DB0};
				}
			}
			...
			namespace menu
			{
				...
				{
					WEAK symbol<UiCommonDataManager*()> GetInstance{0x14098EE30, 0x1405E0F30, 0x14085ED60, 0x1405E0950};
			...
			namespace utility
			{
				...
				WEAK symbol<const char*(fox::StringId)> GetLangText{0x140912C10, 0x140685060, 0x140911D00, 0x140684D40};
				...
				WEAK symbol<bool(fox::ui::SoundControl*, unsigned int)> StopSound{0x14091BA10, 0x14068D2B0, 0x147A8E650, 0x14068CF90};

				WEAK symbol<bool(fox::ui::ModelNodeText*, fox::ui::TextUnit*, const char*)> SetTextForModelNodeText{0x140883520, 0x140689CD0, 0x140916C00, 0x1406899B0};
		...
		namespace net
		{
			...
			{
				WEAK symbol<FobTarget*(ServerManager*)> GetFobTarget{0x1407DCD00, 0x0, 0x1407D5410, 0x0};
			...
			namespace FobTarget_
			{
				...
				WEAK symbol<char(FobTarget*, tpp::mbm::PlayerBasicInfo*, int, unsigned int, char, char)> RequestDetail{0x1407F0F60, 0x0, 0x1407F0050, 0x0};
			...
			{
				WEAK symbol<const char*(FobP2pNameResolver*)> GetPeerName{0x14080D2F0, 0x0, 0x1474CE7E0, 0x0};
			}
	...
	namespace lua
	{
		...
		WEAK symbol<int(lua_State* s, const char*)> luaL_loadstring{0x141A17B30, 0x14CA4F750, 0x14C9A9AF0, 0x14C9BE710};
		WEAK symbol<int(lua_State* s, int, int)> lua_call{0x141A10CC0, 0x14146D200, 0x141A11050, 0x14146D1B0};
		WEAK symbol<int(lua_State* s, int, int, int)> lua_pcall{0x140BF3150, 0x14CA24AB0, 0x141A11A50, 0x14C922AF0};
		...
		WEAK symbol<int(lua_State* L, int)> lua_type{0x141A12300, 0x14146E850, 0x141A12690, 0x14146E800};
		WEAK symbol<const char*(lua_State* L, int)> lua_typename{0x141A12330, 0x14146E880, 0x141A126C0, 0x14146E830};
		WEAK symbol<int(lua_State* L, int)> lua_next{0x141A11600, 0x14146DB40, 0x141A11990, 0x14146DAF0};
		WEAK symbol<void(lua_State* L, int)> lua_settop{0x141A11F70, 0x14146E4B0, 0x141A12300, 0x14146E460};
		WEAK symbol<void(lua_State* L, int)> lua_remove{0x141A11C20, 0x14146E160, 0x141A11FB0, 0x14146E110};

		WEAK symbol<bool(lua_State* L, int)> lua_toboolean{0x141A12330, 0x14CA2BC80, 0x141A12450, 0x14C92AEC0};
		WEAK symbol<int(lua_State* L, int)> lua_tointeger{0x141A12120, 0x14146E670, 0x141A124B0, 0x14146E620};
		WEAK symbol<double(lua_State* L, int)> lua_tonumber{0x141A121F0, 0x14146E740, 0x141A12580, 0x14146E6F0};
		...
		WEAK symbol<void(lua_State* L, const char*)> lua_pushstring{0x141A11970, 0x14146DEB0, 0x14C98DCB0, 0x14146DE60};
...
#define game_lua_pop(L,n) game::lua::lua_settop(L, -(n)-1)
	...
	WEAK symbol<ISteamNetworking*(*)()> SteamNetworking{0x14208E138, 0x14CE237E8, 0x14E1307C0, 0x14CE0D7E8};
	WEAK symbol<ISteamFriends*(*)()> SteamFriends{0x14208E110, 0x14CE237D8, 0x14E1307B8, 0x14CE0D7D8};
	WEAK symbol<ISteamMatchmaking*(*)()> SteamMatchmaking{0x0, 0x14CE237E0, 0x0, 0x14CE0D7E0};
	WEAK symbol<ISteamUser*(*)()> SteamUser{0x14208E128, 0x14CE237F8, 0x14E1307D0, 0x14CE0D7F8};
